...
client.on('interactionCreate', async interaction => {
  ...
  //member = await client.guilds.cache.get("346276641602928641").members.fetch("575472694678781981");
    ...
    if(n>0){
      if(n<11){
	 await interaction.reply("https://play.pokemonshowdown.com/sprites/ani/paras.gif");
	 setTimeout(()=>{for(i=1;i<n;i++)interaction.channel.send("https://play.pokemonshowdown.com/sprites/ani/paras.gif")},500);
